...
const menuItems = [
    { label: "Home", file: "dashboard.html", folder: "", icon: "fa fa-tachometer" },
    { label: "All Requests", file: "allrequest.html", folder: "", icon: "fa fa-tasks" },
    { label: "New Requests", file: "new-request.html", folder: "", icon: "fa fa-plus-circle" },
    { label: "In Progress Requests", file: "inprogress-request.html", folder: "", icon: "fa fa-spinner" },
    { label: "On-Hold Requests", file: "onhold-request.html", folder: "", icon: "fa fa-pause-circle" },
    { label: "Resolved Requests", file: "resolved-request.html", folder: "", icon: "fa fa-check-circle" },
    { label: "Closed Requests", file: "closed-request.html", folder: "", icon: "fa fa-times-circle" },
    { label: "Reopened Requests", file: "re-opened-request.html", folder: "", icon: "fa fa-refresh" },
    { label: "Operator Details", file: "operator-details.html", folder: "", icon: "fa fa-refresh" },
    { label: "Overall EDM Report", file: "re-opened-request.html", folder: "", icon: "fa fa-refresh" },
    { label: "Instructions Received Report", file: "instructions-recieved-report.html", folder: "", icon: "fa fa-refresh" },
    { label: "Helpdesk Tickets", file: "helpdesk-report.html", folder: "", icon: "fa fa-list" },
    { label: "eSevai Operator Change Request Form", file: "esevai-request-form.html", folder: "", icon: "fa fa-lock" },
    { label: "eSevai Operator Change Request Report", file: "esevai-request-report.html", folder: "", icon: "fa fa-lock" },
